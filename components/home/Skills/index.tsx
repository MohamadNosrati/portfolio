...
export const data: SkillCategory[] = [
...

  {
    ...
    title: "UI",
    level: SkillLevel.EXPERT,
    description: "Creating polished, responsive and user-friendly interfaces.",
    branches: [
      "HTML5",
      "Tailwind CSS",
      "Material UI",
...

  {
    ...
    level: SkillLevel.EXPERT,
    description:
      "Managing complex application state and keeping data synchronized.",
...

  {
    ...
    description:
      "Developing cross-platform mobile and progressive web applications.",
...

  {
    ...
    level: SkillLevel.INTERMEDIATE,
    description:
      "Building backend services and APIs that support frontend applications.",
...

  {
    ...
    level: SkillLevel.INTERMEDIATE,
    description:
      "Working with relational and NoSQL databases and data modeling.",
...

  {
    ...
    level: SkillLevel.EXPERT,
    description:
      "Working with collaborative development workflows and source control.",
...

  {
    ...
    title: "Realtime",
    level: SkillLevel.INTERMEDIATE,
    description: "Building real-time communication and event-driven features.",
...

  {
    ...
    description: "Basic experience with application analytics and monitoring.",
    branches: ["PostHog"],
  },

  {
    ...
    level: SkillLevel.EXPERT,
    description:
      "Collaborating effectively, solving problems and working within agile teams.",
    branches: [
      "Problem Solving",
      "Debugging",
      "Communication",
