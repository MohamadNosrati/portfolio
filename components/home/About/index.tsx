  ...
  return (
    ...
    >
      <motion.div
        ...
        className="group relative container mx-auto overflow-hidden rounded-3xl border border-border/50 bg-gradient-to-br from-card via-card to-primary/[0.035] p-6 shadow-sm transition-all duration-500 hover:border-primary/20 hover:shadow-xl hover:shadow-primary/5 md:p-10 lg:p-12"
      >
        <div className="pointer-events-none absolute -right-24 -top-24 size-64 rounded-full bg-primary/[0.06] blur-3xl" />

        <div className="pointer-events-none absolute -bottom-32 -left-24 size-72 rounded-full bg-primary/[0.035] blur-3xl" />

        <div className="absolute left-0 right-0 top-0 h-px bg-gradient-to-r from-transparent via-primary/40 to-transparent" />

        <div className="relative flex gap-10 lg:gap-16 max-lg:flex-col">
          ...
          <div className="hidden lg:block w-px self-stretch bg-gradient-to-b from-transparent via-border to-transparent" />

          <div className="grid w-full flex-1 grid-cols-1 gap-4 sm:grid-cols-2 lg:gap-5">
